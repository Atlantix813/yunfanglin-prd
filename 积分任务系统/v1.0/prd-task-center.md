...
| v1.0 | 2026-05-11 | 技术评审后修订：删除自动发放配置（统一走手动领取+周期重置兜底）、邀请好友页独立拆分、邀请奖励统计文案更新、红点刷新改为进入时查询、功能模块总览重构（分组+锚点跳转）、流程图同步更新 | 俊杰 |
...
- **数据来源**：每次进入个人中心页时请求接口查询当前用户是否存在状态为「待领取奖励」的任务明细记录
