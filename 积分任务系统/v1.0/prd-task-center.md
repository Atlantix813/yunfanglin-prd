...
> **版本**：v1.0 &nbsp;|&nbsp; **负责人**：俊杰 &nbsp;|&nbsp; **更新**：2026-05-09 &nbsp;|&nbsp; **状态**：开发中
...
| 前端效果 | 赚积分 | C端 | · [废弃](#h-c端-赚积分页-废弃-)：由任务中心替代<br>· [邀请奖励发放节点](#h-1-邀请奖励发放节点调整)：扫码即发改为完善信息后发放<br>· [邀请卡片统计](#h-2-邀请卡片统计调整)：新增已完善人数 |
...
| [发放方式] | 手动（用户点击领取）/ 自动（任务配置开启自动发放，或周期重置时系统兜底发放），待领取显示"-" |
